...
//remove DC from both buffers
  for(k=0; k<buffer_len; ++k){
    processingData.an_x[k] = parseInt(register_data.ir_buffer[k]) - parseFloat(f_ir_mean);
    processingData.an_y[k] = parseInt(register_data.red_buffer[k]) - parseFloat(f_red_mean);
